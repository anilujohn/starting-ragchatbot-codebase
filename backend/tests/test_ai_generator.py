...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_handle_tool_execution_multiple_tools(self, mock_anthropic):
        ...
        tool_manager.execute_tool.assert_any_call("search_course_content", query="search 1")
    ...
    def test_multi_round_tool_calling(self, mock_anthropic):
        ...
        # Final response
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Combined information from outline and search")]
        ...
        self.assertEqual(tool_manager.execute_tool.call_count, 2)
        tool_manager.execute_tool.assert_any_call("get_course_outline", course_name="MCP")
        tool_manager.execute_tool.assert_any_call("search_course_content", query="lesson 1 details")
